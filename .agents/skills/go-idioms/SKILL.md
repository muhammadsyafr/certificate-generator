...
> **Scope:** This file covers Go-specific *coding idioms*. For file layout, see `references/project-structure.md in this skill`. For test naming conventions, see `testing-strategy.md`. For logging library choice, see the `logging-implementation` skill.
